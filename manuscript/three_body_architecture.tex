...
$8 \le L \le 400$). This is below Planck PR4 sensitivity but squarely
within the projected reach of Simons Observatory~\cite{SimonsObs2019}
and CMB-S4~\cite{CMBS42016} lensing measurements. Next-generation
lensing will therefore either detect a uniform few-percent
$\phi\phi$ deficit or close this corner entirely: the framework's
cosmological signature is either excluded or presently unobservable,
and the forecast above decides which.
...
below Planck PR4 sensitivity but within reach of Simons Observatory and
CMB-S4. Next-generation lensing will either detect that deficit or
close the framework's cosmological sector entirely.
...
beyond the robustness check performed here; and (iii)~the Simons
